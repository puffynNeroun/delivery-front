...
import {
    ...
    removeFromCart,
    selectCartItems,
    selectCartLoading, clearCartThunk,
...
const Basket = () => {
    ...
    const handleClearCart = () => {
        dispatch(clearCartThunk()); // ✅ вызывает удаление на сервере
    };
        ...
        <section className="py-12 bg-[#0C0C0C] min-h-screen">
            <div className="container mx-auto px-4">
                ...
                <div className="flex justify-between items-center mb-6">
                    <Link to="/">
                        <button className="bg-[#F5920B] hover:bg-[#e28307] text-white font-medium rounded-full px-6 py-2">
                            ← Назад
                        </button>
                    </Link>
                            ...
                            >
                                ...
                                <div className="flex flex-col flex-grow text-white">
                                    ...
                                    <p className="text-sm text-gray-500 mt-1">
                                        Категория: <span className="text-[#F5920B]">{item.category}</span>
                                    </p>
                                    ...
                                    <div className="flex items-center gap-3 mt-3">
                                        ...
                                        <span className="text-[#F5920B] font-bold">{item.quantity}</span>
                                        <button
                                    ...
                                    <div className="mt-3">
                                        ...
                                        <p className="text-md font-bold text-[#F5920B]">
                ...
                {cartItems.length > 0 && (
                    <>
                        <div className="mt-12 bg-[#F5920B] rounded-lg px-8 py-6 text-[#171717] text-xl font-bold shadow-md flex justify-between items-center">
                            <span>Итоговая сумма:</span>
                            <span>{totalPrice} ₽</span>
                        </div>

                        <div className="flex justify-center mt-10">
                            <button className="bg-[#F5920B] hover:bg-[#e28307] text-white text-lg font-bold rounded-full px-10 py-4 shadow-md">
                                Оформить заказ
                            </button>
                        </div>
                    </>
